...
- 모델 역할 선택 후 메인 화면으로 돌아오면 검은 화면이 출력되는 문제
- 연결 후 포토스 버튼 탭시 가이딩 툴 초기화 이슈 수정
- 같은 배율일때 자동으로 렌즈 전환되는 이슈 수정
...
- 레퍼런스 토스트 연결 상태 일때 조건 추가
- 저장된 프레임을 표시하는 FrameDisplayView 추가
- 영어 번역 추가
- 연결 가능한 최소 버전 설정 v1.1.0
...
[Unreleased]: https://github.com/0tak2/zzikzza-cicd-test/compare/v1.2.14...HEAD
[1.2.14]: https://github.com/0tak2/zzikzza-cicd-test/compare/v1.2.13...v1.2.14
